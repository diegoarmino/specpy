...
re2,im2,ex_spec_list2,freq,spec_array2 = raman_ex_disp(np.array(delta_nm[1:7]),omega_nm,omega0[1:7],gamma[1:7],states_list,gamma_scat,sc_range,ex_range,ex_lambdas,trans_dip[1:7])
...
xmin=0.
ymin=0.
idx_v8 = (np.abs(freq - 1737.)).argmin()
